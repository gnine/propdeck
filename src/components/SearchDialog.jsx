...
const quickLinks = [
  { label: "Clients", screen: "clients", icon: Users },
  { label: "All Proposals", screen: "proposals", icon: FileText },
  { label: "Products & Plans", screen: "products", icon: Boxes },
  { label: "New Proposal", screen: "new-proposal", icon: Plus },
];
...
export function SearchDialog({ data, onClose, onNavigate }) {
  ...
  const handleKeyDown = (e) => {
    if (e.key === "ArrowDown") {
      ...
      onNavigate(flatItems[focusedIndex].screen);
    }
  };
    ...
    <div className="search-backdrop" onClick={onClose}>
      <div className="search-dialog" onClick={(e) => e.stopPropagation()} onKeyDown={handleKeyDown}>
        ...
        <div className="search-counts">
          {data.clients.length} clients · {data.proposals.length} proposals · {data.products.length} products indexed locally
