...
import { deleteOne, putOne } from "../../lib/db.js";
...
export function ClientsPage({ data, reload, openNewProposal }) {
  ...
  const deleteClient = async () => {
    ...
    await Promise.all(linkedProposals.map((p) => deleteOne("proposals", p.id)));
    await deleteOne("clients", clientToDelete.id);
    await reload();
