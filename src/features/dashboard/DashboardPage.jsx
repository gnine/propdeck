...
export function DashboardPage({ data, reload, setScreen, openNewProposal }) {
    ...
    <div className="page">
      ...
      <div className="card table-card">
        <div className="table-card-header">
          ...
          <button className="button" onClick={() => setScreen("proposals")}>View all</button>
        </div>
        <ProposalRows
          data={data}
          limit={6}
          onView={setViewingProposal}
          onResend={setResendProposal}
            ...
            <tr key={proposal.id}>
              ...
              <td>
                <div className="row-actions">
                  ...
                  <button onClick={() => onResend?.(proposal)}>Resend</button>
